    ...
    return (
        <>
            <div className='lg:flex justify-between items-center px-[15%] h-screen gap-6'>
                <div className='floating-text mt-5 h-[300px] space-y-20'>
                    <p id="simpleUsage" className='text-white lg:text-5xl text-xl font-mono'>
                        Hi, this is <span className='text-[#938000]'>JAKARIA</span>, Feel free to talk with me...
                    </p>
                    <div className="flex flex-col text-white justify-center items-center text-4xl mt-8 gap-5 space-y-14">
                        ...
                        <div>
                        <button className="btn btn-neutral btn-outline px-10 text-[#938000] font-mono font-semibold">Download CV</button>
                        </div>
                    </div>
                </div>
            </div>
